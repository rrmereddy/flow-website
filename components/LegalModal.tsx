...
export default function LegalModal({
  ...
  const termsAndConditions = [
    ...
    },
    {
      ...
      content:
        'For any questions regarding these Terms, please contact us at [team@roamwithflow.com].',
    },
  ]
  ...
  const privacyPolicy = [
    ...
    },
    {
      ...
      content:
        'We may update this Privacy Policy. Continued use of the app after changes means acceptance of the new policy.',
    },
    {
      heading: '10. Contact Information',
      content:
        'For questions regarding this Privacy Policy, please contact us at [team@roamwithflow.com].',
    },
  ]
  ...
  return (
    <Dialog open={!!openModal} onOpenChange={onCloseAction}>
      <DialogContent className="max-h-[90vh] max-w-2xl">
        ...
        <div className="prose dark:prose-invert max-h-[70vh] overflow-y-auto pr-4">
          <div className="space-y-6">
            {(openModal === 'privacy' ? privacyPolicy : termsAndConditions).map(
              (section, index) => (
                <div key={index} className="space-y-3">
                  <h2 className="text-foreground border-border border-b pb-1 text-xl font-semibold">
                    {section.heading}
                  </h2>
