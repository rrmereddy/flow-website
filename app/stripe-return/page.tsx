    ...
    const handleStripeReturn = async () => {
      try {
        ...
        if (accountId && user) {
            ...
            if ((result.data as { success: boolean }).success) {
              ...
              localStorage.setItem(
                ...
                JSON.stringify({
                  success: false,
                  error:
                    'Stripe account setup incomplete - please complete all required steps',
                  timestamp: Date.now(),
                })
              )
              ...
              setStatus('error')
              toast.error(
                'Stripe account setup is incomplete. Please complete all required steps.'
              )
            }
          } catch (verifyError) {
          ...
          setStatus('error')
          toast.error(
            'Stripe setup appears to be incomplete. Please try again.'
          )
        }
      } catch (error: unknown) {
