        ...
        <div className="bg-card relative mx-auto w-full max-w-md space-y-6 overflow-hidden rounded-lg border p-6 shadow-lg">
            ...
            <TabsContent value="driver">
              <p className="text-muted-foreground text-sm">
                <span className="mt-1 block font-medium text-amber-600">
                  Note: You&apos;ll need to complete additional verification
                  steps in the mobile app after registration.
                </span>
              </p>
            </TabsContent>
          </Tabs>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              ...
              <Label
                htmlFor="terms"
                className="text-md flex cursor-pointer flex-wrap leading-relaxed"
              >
                I agree to the{' '}
                <button
                  type="button"
                  onClick={() => setOpenModal('terms')}
                  className="text-primary font-medium underline hover:cursor-pointer"
                >
