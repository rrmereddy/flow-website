...
export default function Page() {
  ...
  return (
    <div className="from-background to-muted flex min-h-screen flex-col items-center justify-center bg-gradient-to-b p-4 md:p-8">
      <Card className="mx-auto w-full max-w-md shadow-lg">
        ...
        <CardContent className="space-y-4 pb-2 text-center">
          <div className="bg-muted rounded-lg p-4">
            <p className="text-sm">
              You have been successfully signed up. You will receive an email
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="w-full">
            <p className="mb-2 text-center text-sm">Help us spread the word</p>
      ...
      <div className="mt-8 max-w-md text-center">
        ...
        <ul className="text-muted-foreground space-y-3 text-sm">
          <li className="flex items-start">
            ...
            <span>
              We&apos;re working hard to finish the development of our app
            </span>
          </li>
          <li className="flex items-start">
            <span className="bg-primary/10 mr-2 rounded-full p-1">
