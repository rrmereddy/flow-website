    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          View and accept ride requests, manage your upcoming rides.
        </p>
      </div>
        ...
        <CardContent>
          <div className="flex items-center justify-between rounded-lg border p-4">
            <div className="space-y-0.5">
              ...
              <div className="text-muted-foreground text-sm">Downtown Area</div>
            </div>
                ...
                <CardContent className="p-8">
                  <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-muted-foreground mt-2 text-sm">
                      There are currently no ride requests in your area. Check
                      back soon!
                    </p>
                  </div>
                </CardContent>
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">
                    Toggle your status to &quot;Available&quot; to start
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">
                    You don&apos;t have any upcoming rides scheduled. Accept
                    ride requests to see them here.
                  </p>
                </div>
              </CardContent>
            </Card>
